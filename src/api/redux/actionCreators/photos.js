export const GET_PHOTOS_SUCCESS = 'GET_PHOTOS_SUCCESS';// успешный запрос
export const GET_PHOTOS_FAILED = 'GET_PHOTOS_FAILED';// правалинный запрос
export const GET_PHOTOS_STARTED = 'GET_PHOTOS_STARTED';//начальный запрос
